...
If prompted, enter and confirm your email address. The exercise uses your email
address and the exercise date to build your individual evidence and answers.
After setup completes, you will enter `level1` automatically.
